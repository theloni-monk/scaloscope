...
impl Plugin for Scaloscope {
    const NAME: &'static str = "Scaloscope";
    const VENDOR: &'static str = "Thelonious Cooper";
...
impl ClapPlugin for Scaloscope {
    const CLAP_ID: &'static str = "com.theloni.scaloscope";
    const CLAP_DESCRIPTION: Option<&'static str> = Some("A simple constant-q spectrogram plugin.");
